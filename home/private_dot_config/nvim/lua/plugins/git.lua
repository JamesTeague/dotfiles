    ...
    config = function()
      require("gitsigns").setup({
        ...
        on_attach = function(bufnr)
          ...
          end, { desc = "[H]unk [S]tage Line" })
          map("v", "<leader>hr", function()
            gs.reset_hunk({ vim.fn.line("."), vim.fn.line("v") })
          end, { desc = "[H]unk [R]eset Line" })
          ...
          map("n", "<leader>hdf", function()
            gs.diffthis("~")
          end, { desc = "[H]unk [D]iff [F]ile" })
